...
| :--- | :--- | :--- | :---: |
| 💌 **Invitely** | **Plataforma de Invitaciones Digitales Interactivas:** SaaS para creación y gestión de invitaciones interactivas con RSVP en tiempo real, listas de invitados y personalización visual. | `Next.js 15` `TypeScript` `Supabase` `Tailwind CSS` `PostgreSQL` | [📁 Repositorio](https://github.com/arsabot/invitely) • [🌐 Demo en Vivo](https://invitely-delta-dun.vercel.app/login) |
