...
| 🤖 **VocalizAR-AI** | **Herramienta Inteligente de Accesibilidad & OCR:** Síntesis neuronal de voz (TTS), extracción óptica de caracteres desde imágenes/PDFs y resumen con IA. | `React` `Python` `FastAPI` `OpenAI / Gemini API` `Web Speech API` | [📁 Repositorio](https://github.com/arsabot/VocalizAR-AI) • [🌐 Demo](https://arsabot.github.io/#projects) |
...
| 🗣️ **Lingua** | **Tutor de Idiomas con IA & AWS Serverless:** Profesora virtual con streaming en tiempo real, test de nivel automático (A1-C2) y síntesis de voz multi-idioma. | `Node.js 22` `AWS Lambda` `Amazon Bedrock (Claude)` `AWS SAM` `API Gateway` | [📁 Repositorio](https://github.com/arsabot/lingua) • [🌐 Demo en Vivo](https://5lps0yqk1k.execute-api.us-east-1.amazonaws.com/prod/) |
| 💻 **Mac-Duo** | **Dynamic Island Effect para MacBook:** Interfaz conceptual e interacción flotante de notificaciones inspirada en el Dynamic Island para pantallas macOS con muesca. | `Swift` `macOS` `UI/UX` `Desktop App` | [📁 Repositorio](https://github.com/arsabot/Mac-Duo) • [🌐 Demo](https://github.com/arsabot/Mac-Duo) |
